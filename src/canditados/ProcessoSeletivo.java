    ...
    
{
    ...
    static void imprimirSelecionados() { 
         ...
         for(int indice=0; indice < candidatos.length;indice++) {
            System.out.println("O canditado de n°" + (indice+1) + " é o(a)" + candidatos[indice]);
         }
    ...
    String [] candidatos = {"FELIPE","MÁRCIA","JULIA","PAULO","AUGUSTO","MÔNICA","FABRÍCIO","MIRELA","DANIELA","JORGE"};
        ...
        String canditado = candidatos[canditadoAtual];
        double salarioPretendido = valorPretendido();

        System.out.println("O canditado " + canditado + "Solicitou esse valor de salário " + salarioPretendido );
    ...
    static void analisarCanditado(double salarioBase, double salarioPretendido) {
